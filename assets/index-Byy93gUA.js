...
` +
    ...
    var $a = O(null),
      eo = O(0);
    function to(e, t) {
      ((e = Ul), A(eo, e), A($a, t), (Ul = e | t.baseLanes));
    }
    function no() {
      (A(eo, Ul), A($a, $a.current));
    }
    function ro() {
      ((Ul = eo.current), k($a), k(eo));
    }
    var io = O(null),
      ao = null;
    function oo(e) {
    ...
    function Ro(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Er(o, e.memoizedState) && ((ic = !0), d && ((n = ma), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    function cc(e, t, n, r, i) {
      if (e !== null) {
        ...
        if (Dr(a, r) && e.ref === t.ref)
          if (((ic = !1), (t.pendingProps = r = a), Ac(e, i)))
            e.flags & 131072 && (ic = !0);
    ...
    function Mc(e, t, n) {
      if (e !== null)
        if (e.memoizedProps !== t.pendingProps) ic = !0;
          ...
          if (!Ac(e, n) && !(t.flags & 128)) return ((ic = !1), jc(e, t, n));
          ic = !!(e.flags & 131072);
        }
      ...
      switch ((Pi(t), t.tag)) {
        ...
        case 27:
          if (
            ...
            ((e = pe.current),
              Ui(t) ? Vi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Nc(t)));
          }
          return (W(t), null);
        case 5:
        ...
        case 10:
          return (Zi(t.type), W(t), null);
        case 19:
          if ((k(z), (r = t.memoizedState), r === null)) return (W(t), null);
    ...
    function xu() {
      if (J !== null) {
        ...
        else ((e = J), (Yi = Ji = null), ko(e), (Na = null), (Pa = 0), (e = J));
    ...
    function Ku(e, t, n) {
      ...
      (r !== null && r.delete(t),
        ...
        q === e &&
          (Y & n) === n &&
          (Wl === 4 || (Wl === 3 && (Y & 62914560) === Y && 300 > Ne() - $l)
            ? !(K & 2) && Su(e, 0)
            : (ql |= n),
          Yl === Y && (Yl = 0)),
        rd(e));
...
var E = (e) => e,
  ...
  fe = class {
    ...
    add(e) {
      return (T(this.subscriptions, e), () => re(this.subscriptions, e));
    }
    notify(e, t, n) {
...
function ge(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = pe(o, r, i) - e), a > 0 ? (n = o) : (t = o));
  while (Math.abs(a) > me && ++s < he);
  return o;
}
function _e(e, t, n, r) {
  if (e === t && n === r) return E;
...
var ve = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
  ye = (e) => (t) => 1 - e(1 - t),
  be = _e(0.33, 1.53, 0.69, 0.99),
  xe = ye(be),
  Se = ve(xe),
  Ce = (e) =>
    e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * xe(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))),
  we = (e) => 1 - Math.sin(Math.acos(e)),
  Te = ye(we),
  Ee = ve(we),
  De = _e(0.42, 0, 1, 1),
  Oe = _e(0, 0, 0.58, 1),
  ke = _e(0.42, 0, 0.58, 1),
  Ae = (e) => Array.isArray(e) && typeof e[0] != `number`,
  ...
  Pe = (e) => {
    if (je(e)) {
      ...
      let [t, n, r, i] = e;
      return _e(t, n, r, i);
    } else if (Ne(e)) return (Me[e], `${e}`, Me[e]);
    return e;
  },
  Fe = [
    `setup`,
  ...
  Ie = { value: null, addProjectionMetrics: null };
function Le(e, t) {
  let n = new Set(),
    r = new Set(),
    i = !1,
...
function ze(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = Fe.reduce((e, n) => ((e[n] = Le(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      ...
      ((n = !1),
        a ||
          (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, Re), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
...
var {
    ...
    state: Ve,
    steps: He,
  } = ze(typeof requestAnimationFrame < `u` ? requestAnimationFrame : E, !0),
  Ue;
function We() {
  Ue = void 0;
}
var Ge = {
    now: () => (
      Ue === void 0 &&
        Ge.set(
          Ve.isProcessing || ae.useManualTiming
            ? Ve.timestamp
            : performance.now(),
        ),
      Ue
  ...
  Ke = { layout: 0, mainThread: 0, waapi: 0 },
...
var at =
  ...
  ot = (e, t) => (n) =>
    !!(
      (typeof n == `string` && at.test(n) && n.startsWith(e)) ||
      (t && !it(n) && Object.prototype.hasOwnProperty.call(n, t))
    ),
  st = (e, t, n) => (r) => {
  ...
  ct = (e) => ie(0, 255, e),
  lt = { ...$e, transform: (e) => Math.round(ct(e)) },
  ut = {
    test: ot(`rgb`, `red`),
...
var ft = { test: ot(`#`), parse: dt, transform: ut.transform },
  pt = (e) => ({
    test: (t) =>
  ...
  bt = {
    test: (e) => ut.test(e) || ft.test(e) || yt.test(e),
    parse: (e) =>
      ut.test(e) ? ut.parse(e) : yt.test(e) ? yt.parse(e) : ft.parse(e),
    transform: (e) =>
      typeof e == `string`
        ? e
    ...
    getAnimatableNone: (e) => {
      let t = bt.parse(e);
      return ((t.alpha = 0), bt.transform(t));
    },
  },
  xt =
...
function St(e) {
  return (
    isNaN(e) &&
    typeof e == `string` &&
    (e.match(rt)?.length || 0) + (e.match(xt)?.length || 0) > 0
  );
}
var Ct = `number`,
  wt = `color`,
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          bt.test(e)
            ? (r.color.push(a), i.push(wt), n.push(bt.parse(e)))
            : e.startsWith(Et)
...
var Nt = (e) =>
    typeof e == `number` ? 0 : bt.test(e) ? bt.getAnimatableNone(e) : e,
  Pt = (e, t) =>
...
var en = (e) => {
    ...
    return {
      ...
      stop: () => Be(t),
      now: () => (Ve.isProcessing ? Ve.timestamp : Ge.now()),
    };
  },
  tn = (e, t, n = 10) => {
    let r = ``,
...
function un({
  ...
  ((o = ie(P.minDamping, P.maxDamping, o)),
    (e = ie(P.minDuration, P.maxDuration, k(e))),
    o < 1
      ? ((i = (t) => {
          let r = t * o,
            i = r * e,
...
function yn(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = ue(Array.isArray(t) ? t[n] || E : t, a)), r.push(a));
  }
  return r;
}
...
var An = class {
  ...
  Mn = class extends An {
    ...
    initAnimation() {
      ...
      s !== Tn &&
        typeof o[0] != `number` &&
        ((this.mixKeyframes = ue(jn, $t(o[0], o[1]))), (o = [0, 100]));
...
var or = class {
    ...
    scheduleResolve() {
      ((this.state = `scheduled`),
        this.isAsync
          ? ($n.add(this),
            er || ((er = !0), j.read(ir), j.resolveKeyframes(rr)))
...
function gr(
  ...
  c && (u.offset = c);
  let d = hr(s, i);
  (Array.isArray(d) && (u.easing = d), Ie.value && Ke.waapi++);
  let f = {
    delay: r,
    duration: i,
...
var yr = class extends An {
    ...
    set time(e) {
      ...
      ((this.manualStartTime = null),
        (this.finishedTime = null),
        (this.animation.currentTime = O(e)),
  ...
  br = { anticipate: Ce, backInOut: Se, circInOut: Ee };
function xr(e) {
  return e in br;
}
function Sr(e) {
  ...
  wr = class extends yr {
    ...
    updateMotionValue(e) {
      ...
      let o = new Mn({ ...a, autoplay: !1 }),
        s = Math.max(Cr, Ge.now() - this.startTime),
        c = ie(0, Cr, s - Cr),
        l = o.sample(s).value,
        { name: u } = this.options;
      (i && u && cr(i, u, l),
...
var Mr = new Set([
  ...
  Nr = le(() => Object.hasOwnProperty.call(Element.prototype, `animate`));
function Pr(e) {
  let {
    motionValue: t,
    name: n,
...
var { schedule: Bi, cancel: Vi } = ze(queueMicrotask, !1),
  Hi = { x: !1, y: !1 };
function Ui() {
  return Hi.x || Hi.y;
}
...
function so(e, t, n, r = !1) {
  ...
  for (let s = 0; s < i; s++) {
    ...
    (i && i.props.style && i.props.style.display === `contents`) ||
      ...
      r && Qa(a.latestValues) && z(e, a.latestValues, a.layout?.layoutBox));
  }
...
var Co = class extends Ga {
  ...
  wo = { offset: `stroke-dashoffset`, array: `stroke-dasharray` },
...
function ts(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.scale >= Jo && e.scale <= Yo) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= Zo && e.translate <= Qo) || isNaN(e.translate)) &&
      (e.translate = 0));
}
function ns(e, t, n, r) {
...
function rs(e, t, n, r = 0) {
  ((e.min = (r ? N(n.min, n.max, r) : n.min) + t.min), (e.max = e.min + $o(t)));
}
function is(e, t, n, r) {
...
var us = [`x`, `scaleX`, `originX`],
  ds = [`y`, `scaleY`, `originY`];
function fs(e, t, n, r) {
  (ls(e.x, t, us, n ? n.x : void 0, r ? r.x : void 0),
    ls(e.y, t, ds, n ? n.y : void 0, r ? r.y : void 0));
}
function ps(e) {
...
var Cs = [
  ...
  ws = Cs.length,
  Ts = (e) => (typeof e == `string` ? parseFloat(e) : e),
  Es = (e) => typeof e == `number` || M.test(e);
function Ds(e, t, n, r, i, a) {
  i
    ? ((e.opacity = N(0, n.opacity ?? 1, ks(r))),
      (e.opacityExit = N(t.opacity ?? 1, 0, As(r))))
  ...
  for (let i = 0; i < ws; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || Es(o) === Es(s)
        ? ((e[a] = Math.max(N(Ts(o), Ts(s), r), 0)),
          (ht.test(s) || ht.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
var Ps = (e, t) => e.depth - t.depth,
  Fs = class {
    ...
    forEach(e) {
      (this.isDirty && this.children.sort(Ps),
        (this.isDirty = !1),
...
var Rs = class {
  ...
  Bs = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
  Vs = [``, `X`, `Y`, `Z`],
  Hs = 1e3,
  Us = 0;
function Ws(e, t, n, r) {
  ...
  return class {
      ...
      ((this.id = Us++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            Ie.value &&
              (Bs.nodes =
                Bs.calculatedTargetDeltas =
                Bs.calculatedProjections =
                  0),
            this.nodes.forEach(Ys),
            this.nodes.forEach(ic),
            this.nodes.forEach(ac),
            this.nodes.forEach(Xs),
            Ie.addProjectionMetrics && Ie.addProjectionMetrics(Bs));
        }),
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              zs.hasAnimatedSinceResize &&
                ((zs.hasAnimatedSinceResize = !1), this.nodes.forEach(rc)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({
              ...
              let a = this.options.transition || i.getDefaultTransition() || fc,
                { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } =
                  i.getProps(),
                c = !this.targetLayout || !vs(this.targetLayout, r),
                l = !t && n;
              if (
    ...
    update() {
      ...
      ((this.animationCommitId = this.animationId),
        ...
        this.clearAllSnapshots());
      let e = Ge.now();
      ((Ve.delta = ie(0, 1e3 / 60, e - Ve.timestamp)),
        (Ve.timestamp = e),
        (Ve.isProcessing = !0),
        He.update.process(Ve),
        He.preRender.process(Ve),
        He.render.process(Ve),
        (Ve.isProcessing = !1));
    }
    didUpdate() {
    ...
    clearAllSnapshots() {
      (this.nodes.forEach(Zs), this.sharedNodes.forEach(sc));
    }
    ...
    resetTransform() {
      ...
      let e =
        ...
        t = this.projectionDelta && !ms(this.projectionDelta),
    ...
    removeElementScroll(e) {
      ...
      for (let n = 0; n < this.path.length; n++) {
        ...
        r !== this.root &&
          i &&
          a.layoutScroll &&
          (i.wasRoot && Go(t, e), co(t.x, i.offset.x), co(t.y, i.offset.y));
      }
      return t;
    }
    applyTransform(e, t = !1, n) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        (!t &&
          ...
          Qa(n.latestValues) && z(r, n.latestValues, n.layout?.layoutBox));
      }
      return (
        Qa(this.latestValues) &&
          z(r, this.latestValues, this.layout?.layoutBox),
        r
      );
    }
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        (n.instance &&
          ...
          (r = Da()),
          Go(r, n.measurePageBox())),
          fs(t, n.latestValues, n.snapshot?.layoutBox, r));
      }
      return (Qa(this.latestValues) && fs(t, this.latestValues), t);
    }
    setTargetDelta(e) {
      ((this.targetDelta = e),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          this.relativeParent.target
            ...
            : this.targetDelta
              ? (this.resumingFrom
                  ...
                  : Go(this.target, this.layout.layoutBox),
          ...
          Ie.value && Bs.calculatedTargetDeltas++));
    }
    ...
    createRelativeTarget(e, t, n) {
      ((this.relativeParent = e),
        ...
        Go(this.relativeTarget, this.relativeTargetOrigin));
    }
    ...
    calcProjection() {
      ...
      if (
        ...
        t &&
          ...
          (n = !1),
        this.resolvedRelativeTargetAt === Ve.timestamp && (n = !1),
        n)
      )
        return;
      let { layout: r, layoutId: i } = this.options;
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        ns(this.projectionDelta, this.layoutCorrected, s, this.latestValues),
        (this.treeScale.x !== a ||
          this.treeScale.y !== o ||
        ...
        Ie.value && Bs.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      let o = Da(),
        ...
        u = !!(s && !l && this.options.crossfade === !0 && !this.path.some(dc));
      this.animationProgress = 0;
      let d;
      ((this.mixTargetDelta = (t) => {
        ...
        (cc(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            uc(this.relativeTarget, this.relativeTargetOrigin, o, n),
            d && gs(this.relativeTarget, d) && (this.isProjectionDirty = !1),
            (d ||= Da()),
            Go(d, this.relativeTarget)),
          s &&
            ((this.animationValues = i), Ds(i, r, this.latestValues, n, u, l)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    startAnimation(e) {
      (this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation &&= (Be(this.pendingAnimation), void 0)),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          _c(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || Da();
        ...
        (Go(t, n),
          z(t, i),
          ns(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new Rs()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Vs.length; t++)
        (Ws(`rotate${Vs[t]}`, e, r, this.animationValues),
          Ws(`skew${Vs[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      if (this.needsReset) {
        ((this.needsReset = !1),
          (e.visibility = ``),
          (e.opacity = ``),
          (e.pointerEvents = Ls(t?.pointerEvents) || ``),
      ...
      this.options.layoutId &&
        (e.pointerEvents = r === this ? Ls(t?.pointerEvents) || `` : `none`);
    }
    clearSnapshot() {
...
function uc(e, t, n, r) {
  (lc(e.x, t.x, n.x, r), lc(e.y, t.y, n.y, r));
}
function dc(e) {
  return e.animationValues && e.animationValues.opacityExit !== void 0;
}
var fc = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
  pc = (e) =>
    typeof navigator < `u` &&
    navigator.userAgent &&
    navigator.userAgent.toLowerCase().includes(e),
  mc = pc(`applewebkit/`) && !pc(`chrome/`) ? Math.round : E;
function hc(e) {
  ((e.min = mc(e.min)), (e.max = mc(e.max)));
}
function gc(e) {
  (hc(e.x), hc(e.y));
}
function _c(e, t, n) {
  return (
    e === `position` || (e === `preserve-aspect` && !es(ys(t), ys(n), 0.2))
  );
}
function vc(e) {
    ...
    if (n)
      return () => {
        for (let t = 0; t < r.length; t++) {
          let n = r[t];
          typeof n == `function` ? n() : Cc(e[t], null);
        }
      };
  };
}
function Tc(...e) {
  return b.useCallback(wc(...e), e);
}
var U = C(),
  Ec = class extends b.Component {
...
function Dc({
  ...
  let o = (0, b.useId)(),
    ...
    { nonce: l } = (0, b.useContext)(Sc),
    u = Tc(s, e.props?.ref ?? e?.ref);
  return (
...
var Oc = ({
  ...
  return (
    ...
    (0, U.jsx)(ne.Provider, { value: p, children: e })
  );
};
function kc() {
  return new Map();
...
var Nc = ({
    ...
    if (f !== v) {
      ...
      return (a === `wait` && C.length && (e = C), S(Mc(e)), y(f), null);
    }
...
function Lc() {
  if (Ic) return;
  let e = {};
  for (let t in Fc) e[t] = { isEnabled: (e) => Fc[t].some((t) => !!e[t]) };
  (Ha(e), (Ic = !0));
}
function W() {
  return (Lc(), Ua());
...
function Yc(e) {
  let { initial: t, animate: n } = Jc(e, (0, b.useContext)(qc));
  return (0, b.useMemo)(() => ({ initial: t, animate: n }), [Xc(t), Xc(n)]);
}
function Xc(e) {
  return Array.isArray(e) ? e.join(` `) : e;
}
var Zc = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
function Qc(e, t, n) {
  for (let r in t) !F(t[r]) && !xo(r, n) && (e[r] = t[r]);
}
function $c({ transformTemplate: e }, t) {
  return (0, b.useMemo)(() => {
    let n = Zc();
...
function el(e, t) {
  let n = e.style || {},
    r = {};
  return (Qc(r, n, e), Object.assign(r, $c(e, t)), r);
}
function tl(e, t) {
  let n = {},
    r = el(e, t);
...
function rl(e, t, n, r) {
  let i = (0, b.useMemo)(() => {
    let n = nl();
    return (
      Oo(n, t, Ao(r), e.transformTemplate, e.style),
...
function al(e) {
  return typeof e != `string` || e.includes(`-`)
    ? !1
    : !!(il.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function ol(e, t, n, { latestValues: r }, i, a = !1, o) {
  let s = ((o ?? al(e)) ? rl : tl)(t, r, i, e),
    c = Kc(t, typeof e == `string`, a),
...
function sl({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
  return { latestValues: G(n, r, i, e), renderState: t() };
}
function G(e, t, n, r) {
  let i = {},
    a = r(e, {});
  for (let e in a) i[e] = Ls(a[e]);
...
var cl = (e) => (t, n) => {
  ...
  ll = cl({ scrapeMotionValuesFromProps: H, createRenderState: Zc }),
  ul = cl({ scrapeMotionValuesFromProps: Mo, createRenderState: nl }),
...
function gl(e, t, n, r) {
  ...
  ((e.projection = new n(
    e.latestValues,
    t[`data-framer-portal-id`] ? void 0 : _l(e.parent),
  )),
    e.projection.setOptions({
      layoutId: i,
      layout: a,
      alwaysMeasureLayout: !!o || (s && ml(s)),
      visualElement: e,
...
function _l(e) {
  if (e) return e.options.allowProjection === !1 ? _l(e.parent) : e.projection;
}
function vl(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  r && Rc(r);
  let a = n ? n === `svg` : al(e),
    o = a ? ul : ll;
  function s(n, s) {
    let c,
      l = { ...(0, b.useContext)(Sc), ...n, layoutId: yl(n) },
      { isStatic: u } = l,
      d = Yc(n),
      f = o(n, u);
    if (!u && typeof window < `u`) {
      ...
      let t = xl(l);
      ((c = t.MeasureLayout),
        (d.visualElement = hl(e, f, l, i, t.ProjectionNode, a)));
    }
    return (0, U.jsxs)(qc.Provider, {
      value: d,
      children: [
        c && d.visualElement
          ? (0, U.jsx)(c, { visualElement: d.visualElement, ...l })
          : null,
        ol(e, n, fl(f, d.visualElement, s), f, u, t, a),
      ],
    });
  }
...
function Sl(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) =>
      a === `create`
        ? r
        : (n.has(a) || n.set(a, vl(a, void 0, e, t)), n.get(a)),
  });
}
var Cl = (e, t) =>
    (t.isSVG ?? al(e))
      ? new No(t)
      : new Co(t, { allowProjection: e !== b.Fragment }),
  wl = class extends Ka {
    constructor(e) {
...
var Ol = (e) => (t) => Yi(t) && e(t, Dl(t));
function kl(e, t, n, r) {
  return Ns(e, t, Ol(n), r);
}
var Al = ({ current: e }) => (e ? e.ownerDocument.defaultView : null),
  jl = (e, t) => Math.abs(e - t);
function Ml(e, t) {
  let n = jl(e.x, t.x),
    r = jl(e.y, t.y);
...
var Nl = new Set([`auto`, `scroll`]),
  Pl = class {
    constructor(
      ...
      if (
        ...
        (this.updatePoint = () => {
          ...
          this.lastRawMoveEventInfo &&
            (this.lastMoveEventInfo = Fl(
              this.lastRawMoveEventInfo,
              this.transformPagePoint,
            ));
          let e = Ll(this.lastMoveEventInfo, this.history),
        ...
        (this.handlePointerMove = (e, t) => {
          ((this.lastMoveEvent = e),
            ...
            (this.lastMoveEventInfo = Fl(t, this.transformPagePoint)),
      ...
      let s = Fl(Dl(e), this.transformPagePoint),
        { point: c } = s,
        { timestamp: l } = Ve;
      this.history = [{ ...c, timestamp: l }];
      let { onSessionStart: u } = t;
      (u && u(e, Ll(s, this.history)),
    ...
    startScrollTracking(e) {
      ...
      for (; t;) {
        ...
        ((Nl.has(e.overflowX) || Nl.has(e.overflowY)) &&
...
function X(e, { top: t, left: n, bottom: r, right: i }) {
  return { x: Y(e.x, n, i), y: Y(e.y, t, r) };
}
function zl(e, t) {
  let n = t.min - e.min,
    r = t.max - e.max;
...
function Bl(e, t) {
  return { x: zl(e.x, t.x), y: zl(e.y, t.y) };
}
function Vl(e, t) {
  let n = 0.5,
    r = $o(e),
...
function Wl(e = Ul) {
  return (
    e === !1 ? (e = 0) : e === !0 && (e = Ul),
    { x: Gl(e, `left`, `right`), y: Gl(e, `top`, `bottom`) }
  );
}
function Gl(e, t, n) {
...
var ql = new WeakMap(),
  Jl = class {
    ...
    start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
      ...
      let i = (e) => {
          (t && this.snapToCursor(Dl(e).point), this.stopAnimation());
        },
        a = (e, t) => {
    ...
    updateAxis(e, t, n) {
      ...
      (this.constraints &&
        this.constraints[e] &&
        (a = J(a, this.constraints[e], this.elastic[e])),
        i.set(a));
    }
    resolveConstraints() {
      ...
      (e && ml(e)
        ...
        : e && n
          ? (this.constraints = X(n.layoutBox, e))
          : (this.constraints = !1),
        (this.elastic = Wl(t)),
        r !== this.constraints &&
          !ml(e) &&
          ...
          xs((e) => {
            this.constraints !== !1 &&
              ...
              (this.constraints[e] = Hl(n.layoutBox[e], this.constraints[e]));
          }));
    }
    ...
    scalePositionWithinConstraints() {
      ...
      if (!ml(t) || !n || !this.constraints) return;
      this.stopAnimation();
      let r = { x: 0, y: 0 };
      xs((e) => {
        ...
        if (t && this.constraints !== !1) {
          let n = t.get();
          r[e] = Vl({ min: n, max: n }, this.constraints[e]);
        }
      });
    ...
    addListeners() {
      ...
      (i && !i.layout && (i.root && i.root.updateScroll(), i.updateLayout()),
        j.read(r));
      let o = Ns(window, `resize`, () => this.scalePositionWithinConstraints()),
...
var $l = class extends Ka {
  ...
  tu = class extends Ka {
    ...
    mount() {
      this.removePointerDownListener = kl(
        this.node.current,
        `pointerdown`,
...
function iu(e) {
  ...
  return (0, U.jsx)(ru, {
    ...e,
    layoutGroup: r,
    switchLayoutGroup: (0, b.useContext)(pl),
    isPresent: t,
    safeToRemove: n,
  });
}
var au = {
  pan: { Feature: tu },
  drag: { Feature: $l, ProjectionNode: xc, MeasureLayout: iu },
};
function ou(e, t, n) {
  let { props: r } = e;
  e.animationState &&
...
var bu = {
  ...
  xu = { layout: { ProjectionNode: xc, MeasureLayout: iu } },
  Su = Sl({ ...El, ...bu, ...au, ...xu }, Cl),
  Cu = [`Q`, `W`, `E`, `R`, `T`, `Y`, `U`, `I`, `O`, `P`],
  wu = [`A`, `S`, `D`, `F`, `G`, `H`, `J`, `K`, `L`],
  Tu = [`Z`, `X`, `C`, `V`, `B`, `N`, `M`];
function Eu({ value: e, onChange: t }) {
  let [n, r] = (0, b.useState)(!0),
    i = (0, b.useCallback)(
      (r) => {
        t(e + (n ? r : r.toLowerCase()));
      },
      [e, t, n],
    ),
    a = (0, b.useCallback)(() => {
  ...
  return (0, U.jsxs)(`div`, {
    className: `mt-4 w-full max-w-2xl select-none rounded-2xl border border-[#f7f7f7] bg-[#e8e8e8] p-2 shadow-inner sm:p-3`,
    role: `group`,
    ...
    children: [
      (0, U.jsx)(`div`, {
        ...
        children: (0, U.jsx)(`button`, {
          type: `button`,
          onClick: () => r((e) => !e),
          className: `rounded-xl border border-[#f7f7f7] bg-white px-4 py-2 text-sm font-semibold text-[#333F48] shadow-sm active:scale-95`,
          children: n ? `ABC (caps)` : `abc (lower)`,
        }),
      }),
      (0, U.jsx)(`div`, {
        ...
        children: Cu.map((e) =>
          (0, U.jsx)(
            Du,
            { label: n ? e : e.toLowerCase(), onPress: () => i(e) },
            e,
          ),
        ),
      }),
      (0, U.jsx)(`div`, {
        className: `mt-1.5 flex flex-wrap justify-center gap-1.5 pl-3 sm:mt-2 sm:gap-2 sm:pl-6`,
        children: wu.map((e) =>
          (0, U.jsx)(
            Du,
            { label: n ? e : e.toLowerCase(), onPress: () => i(e) },
      ...
      (0, U.jsxs)(`div`, {
        className: `mt-1.5 flex flex-wrap items-center justify-center gap-1.5 sm:mt-2 sm:gap-2`,
        children: [
          Tu.map((e) =>
            (0, U.jsx)(
              Du,
          ...
          (0, U.jsx)(`button`, {
            type: `button`,
            onClick: a,
            className: `min-h-12 min-w-[4.5rem] rounded-xl border border-[#f7f7f7] bg-white px-3 text-sm font-semibold text-[#333F48] shadow-sm active:scale-95 sm:min-h-14 sm:text-base`,
            children: `⌫ Back`,
          }),
        ],
      }),
      (0, U.jsx)(`div`, {
        className: `mt-1.5 flex justify-center sm:mt-2`,
        children: (0, U.jsx)(`button`, {
          type: `button`,
          onClick: o,
          className: `min-h-12 w-full max-w-md rounded-xl border border-[#f7f7f7] bg-white px-4 text-sm font-semibold text-[#333F48] shadow-sm active:scale-95 sm:min-h-14 sm:text-base`,
          children: `Space`,
        }),
      }),
    ],
...
function Du({ label: e, onPress: t }) {
  return (0, U.jsx)(`button`, {
    type: `button`,
    onClick: (e) => { e.stopPropagation(); t(); },
    className: `flex min-h-12 min-w-10 touch-manipulation items-center justify-center rounded-xl border border-[#f7f7f7] bg-white px-2.5 text-lg font-semibold text-[#333F48] shadow-sm active:scale-95 sm:min-h-14 sm:min-w-11 sm:text-xl`,
    children: e,
  });
}
function Ou({ onSubmit: e, loading: t, error: n }) {
  let [r, i] = (0, b.useState)(``);
  return (0, U.jsx)(`div`, {
    className: `flex min-h-0 w-full max-w-2xl flex-1 flex-col items-center justify-start overflow-y-auto px-4 py-4 pt-2 sm:px-6 sm:py-6`,
    children: (0, U.jsxs)(Su.div, {
      className: `w-full`,
      ...
      children: [
        (0, U.jsx)(`h2`, {
          className: `mb-1 text-2xl font-bold text-[#333F48] sm:text-3xl`,
          style: { fontFamily: `var(--font-body, system-ui, sans-serif)` },
          children: `Enter Your Name`,
        }),
        (0, U.jsx)(`p`, {
          className: `mb-6 text-[#333F48] sm:text-base`,
          children: `Use the on-screen keyboard below to enter your name.`,
        }),
        (0, U.jsxs)(`form`, {
          onSubmit: (t) => {
            (t.preventDefault(), e({ name: r }));
          },
          ...
          children: [
            (0, U.jsxs)(`div`, {
              children: [
                (0, U.jsxs)(`label`, {
                  htmlFor: `m-name`,
                  className: `mb-2 block text-left text-sm font-medium text-[#333F48]`,
                  children: [
                    `Name`,
                    (0, U.jsx)(`span`, {
                      className: `ml-0.5 text-[#DA1F2C]`,
                      "aria-hidden": !0,
                      children: `*`,
                    }),
                  ],
                ...
                (0, U.jsx)(`input`, {
                  ...
                  required: !0,
                  "aria-readonly": `true`,
                  className: `h-14 w-full cursor-default rounded-2xl border border-[#f7f7f7] bg-[#e8e8e8] px-4 text-[#333F48] shadow-inner outline-none ring-0 placeholder:text-[#333F48]/45 focus:border-[#DA1F2C]/75 focus:ring-2 focus:ring-[#DA1F2C]/30`,
                  placeholder: `Tap keys below`,
                }),
              ],
            }),
            (0, U.jsx)(Eu, { value: r, onChange: i }),
            n
              ? (0, U.jsx)(`p`, {
                  className: `rounded-xl border border-[#DA1F2C]/45 bg-[#DA1F2C]/15 px-3 py-2 text-left text-sm text-[#333F48]`,
                  children: n,
                })
              : null,
            (0, U.jsx)(Su.button, {
              type: `submit`,
              disabled: t,
              whileTap: t ? void 0 : { scale: 0.98 },
              className: `h-16 w-full rounded-2xl border border-[#DA1F2C]/70 bg-gradient-to-b from-[#DA1F2C] to-[#AB2328] text-lg font-semibold text-white shadow-[0_10px_28px_rgba(0,0,0,0.45),0_0_26px_rgba(218,31,44,0.28)] transition disabled:cursor-wait disabled:opacity-60`,
              style: { fontFamily: `var(--font-body, system-ui, sans-serif)` },
...
var ku = `./`,
  Au = Array.from({ length: 18 }, (e, t) => `${ku}images/img${t + 1}.png`);
function ju(e) {
  return e.length === 0
    ? Promise.resolve()
    : Promise.all(
...
function Mu({
  ...
  let o = t,
    s = `cMark-${(0, b.useId)().replace(/:/g, ``)}`,
    c = (0, b.useCallback)(() => {
      i || a();
    }, [i, a]);
  return (0, U.jsx)(`div`, {
    className: `perspective-1000 aspect-[1.58/1] w-full p-1 sm:p-1.5 ${r ? `card-mismatch-pulse` : ``}`,
    children: (0, U.jsx)(`button`, {
      type: `button`,
      onClick: c,
      disabled: i,
      className: `relative h-full w-full touch-manipulation select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-[#DA1F2C]/80 active:shadow-[inset_0_0_0_2px_rgba(218,31,44,0.4)] disabled:cursor-not-allowed`,
      style: { WebkitTapHighlightColor: `transparent` },
      "aria-pressed": o,
      "aria-label": o ? `Revealed card` : `Face-down card, tap to flip`,
      children: (0, U.jsxs)(`div`, {
        className: `transform-style-3d relative h-full w-full transition-transform duration-500 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]`,
        style: {
        ...
        children: [
          (0, U.jsxs)(`div`, {
            className: `absolute inset-0 overflow-hidden rounded-[16px] border border-[#33424A]/90 shadow-[0_10px_26px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.08)]`,
            style: {
              transform: `translateZ(1px) rotateY(0deg)`,
              backfaceVisibility: `hidden`,
              WebkitBackfaceVisibility: `hidden`,
              background: `radial-gradient(circle at 30% 20%, rgba(218,31,44,0.14), transparent 52%),repeating-linear-gradient(45deg, rgba(255,255,255,0.03) 0 8px, transparent 8px 16px),linear-gradient(145deg, #0a0a0a, #13181c 45%, #33424a)`,
            },
            children: [
              (0, U.jsx)(`div`, {
                className: `absolute inset-0 flex items-center justify-center`,
                children: (0, U.jsxs)(`svg`, {
                  className: `h-[66%] w-[66%] max-h-[4rem] max-w-[4rem] opacity-90`,
                  viewBox: `0 0 64 64`,
                  fill: `none`,
                  "aria-hidden": !0,
                  children: [
                    (0, U.jsx)(`defs`, {
                      children: (0, U.jsxs)(`linearGradient`, {
                        ...
                        children: [
                          (0, U.jsx)(`stop`, {
                            offset: `0%`,
                            stopColor: `rgb(218 31 44 / 0.5)`,
                          }),
                          (0, U.jsx)(`stop`, {
                            offset: `100%`,
                            stopColor: `rgb(171 35 40 / 0.4)`,
                          }),
                        ],
                      }),
                    }),
              ...
              (0, U.jsx)(`div`, {
                className: `pointer-events-none absolute inset-0 bg-[linear-gradient(120deg,transparent_22%,rgba(255,255,255,0.08)_45%,transparent_70%)]`,
              }),
              r &&
                (0, U.jsx)(`div`, {
                  className: `pointer-events-none absolute inset-0 rounded-[16px] ring-2 ring-[#DA1F2C] ring-inset shadow-[0_0_16px_rgba(218,31,44,0.55)]`,
                }),
            ],
          }),
          (0, U.jsxs)(`div`, {
            className: `absolute inset-0 overflow-hidden rounded-[16px] border border-[#33424A]/90 bg-black/40 shadow-[0_10px_30px_rgba(0,0,0,0.5)]`,
            style: {
            ...
            children: [
              ...
              n &&
                (0, U.jsx)(`div`, {
                  className: `pointer-events-none absolute inset-0 rounded-[16px] ring-2 ring-[#DA1F2C]/90 ring-inset shadow-[0_0_18px_rgba(218,31,44,0.55)]`,
                }),
              r &&
                (0, U.jsx)(`div`, {
                  className: `pointer-events-none absolute inset-0 rounded-[16px] ring-2 ring-[#DA1F2C] ring-inset shadow-[0_0_16px_rgba(218,31,44,0.55)]`,
              ...
              (0, U.jsx)(`div`, {
                className: `pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.08),transparent_35%),radial-gradient(circle_at_70%_80%,rgba(0,0,0,0.2),transparent_55%)]`,
              }),
            ],
          }),
        ],
...
var Nu = null;
function Pu() {
  if (typeof window > `u` || !window.AudioContext) return null;
  if (!Nu) {
    let e = window.AudioContext || window.webkitAudioContext;
    if (!e) return null;
    Nu = new e();
  }
  return (Nu.state === `suspended` && Nu.resume().catch(() => {}), Nu);
}
function Fu(e, t, n = `sine`, r = 0.12) {
  let i = Pu();
  if (!i) return;
  let a = i.createOscillator(),
    o = i.createGain();
  ((a.type = n),
    a.frequency.setValueAtTime(e, i.currentTime),
    o.gain.setValueAtTime(r, i.currentTime),
    o.gain.exponentialRampToValueAtTime(1e-4, i.currentTime + t),
    a.connect(o),
    o.connect(i.destination),
    a.start(i.currentTime),
    a.stop(i.currentTime + t));
}
function Iu() {
  Fu(220, 0.06, `sine`, 0.08);
}
function Lu() {
  (Fu(523, 0.1, `triangle`, 0.1),
    setTimeout(() => Fu(784, 0.12, `triangle`, 0.09), 60),
    setTimeout(() => Fu(1046, 0.2, `sine`, 0.07), 140));
}
function Ru() {
  (Fu(140, 0.12, `sawtooth`, 0.05),
    setTimeout(() => Fu(120, 0.15, `sawtooth`, 0.04), 100));
}
function zu() {
  (Fu(392, 0.1, `sine`, 0.09),
    setTimeout(() => Fu(523, 0.1, `sine`, 0.08), 90),
    setTimeout(() => Fu(659, 0.15, `sine`, 0.1), 180),
    setTimeout(() => Fu(784, 0.3, `sine`, 0.08), 300));
}
function Bu(e) {
  let t = [...e];
...
function Vu({
  ...
  let s = (0, b.useMemo)(() => Au.slice(0, a), [a]),
    [c, l] = (0, b.useState)(!1),
    u = (0, b.useMemo)(() => {
      let e = Au.slice(0, a);
      if (e.length < a)
        for (let t = e.length; t < a; t += 1) e.push(Au[t % Au.length]);
      return Bu(
        e.flatMap((e, t) => [
          { id: `c-${t}-a`, key: t, image: e },
          { id: `c-${t}-b`, key: t, image: e },
        ]),
      );
    }, [a, t]);
  (0, b.useEffect)(() => {
  ...
  ((0, b.useEffect)(() => {
    ...
    (0, b.useEffect)(() => {
      if (!c) return;
      ((T.current = Date.now()), ie(n));
      let e = setInterval(() => {
        let e = se.current;
        if (e != null) {
          let t = Math.max(0, Math.floor((e - T.current) / 1e3));
          ie(Math.max(0, n - t));
          return;
        }
        let t = Math.floor((Date.now() - T.current) / 1e3);
        ie(Math.max(0, n - t));
      }, 200);
      return () => clearInterval(e);
    }, [t, c, n]));
  let le = u.length > 0 && d.size === u.length;
  ((0, b.useEffect)(() => {
    if (!le) return;
    ((se.current ??= Date.now()),
      ee(!0),
      ne(!0),
      ce.current || ((ce.current = !0), zu()));
    let e = !0,
      t = setTimeout(() => {
        e &&
          o.current({
            ...
            time: Math.max(
              0,
              Math.floor(((se.current ?? Date.now()) - T.current) / 1e3),
            ),
            moves: ae.current,
            pairs: a,
            didWin: !0,
  ...
  let E = (0, b.useCallback)(
      (e) => {
        if (
          c &&
          !(_ || w) &&
          (i?.(), !d.has(e) && !p.includes(e) && !(p.length >= 2))
        ) {
          if ((Iu(), p.length === 0)) {
            m([e]);
            return;
    ...
    D =
      e === 4
        ? `grid-cols-4 max-w-5xl xl:max-w-6xl`
        : `grid-cols-6 max-w-6xl xl:max-w-7xl`;
  return (0, U.jsxs)(`div`, {
    className: `flex w-full max-w-5xl flex-1 flex-col items-center justify-start gap-3 px-3 py-2 sm:gap-4 sm:px-4`,
    children: [
      (0, U.jsxs)(`div`, {
        className: `z-10 flex w-full max-w-4xl flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6`,
        children: [
          (0, U.jsxs)(`div`, {
            className: `min-w-[7rem] rounded-2xl border border-[#f7f7f7] bg-[#e8e8e8] px-4 py-2 text-center shadow-lg backdrop-blur-md`,
            children: [
              (0, U.jsx)(`p`, {
                className: `text-[0.7rem] font-medium uppercase tracking-widest text-[#333F48]`,
                children: `Countdown`,
              }),
              (0, U.jsx)(Su.p, {
                ...
                animate:
                  re <= 10
                    ? {
                        scale: [1, 1.06, 1],
                        color: [`#DA1F2C`, `#FFFFFF`, `#DA1F2C`],
                      }
                    : { scale: 1, color: `#DA1F2C` },
                transition:
                  re <= 10
                    ? { duration: 0.9, ease: `easeInOut`, repeat: 1 / 0 }
                    : { duration: 0.2 },
                children: ((e) =>
                  `${String(Math.floor(e / 60))}:${String(e % 60).padStart(2, `0`)}`)(
                  re,
                ),
              }),
            ],
          ...
          (0, U.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, U.jsx)(`p`, {
                className: `text-xl font-semibold text-[#DA1F2C] sm:text-2xl`,
                children: S,
              }),
            ],
          }),
          (0, U.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, U.jsx)(`p`, {
                className: `text-xl font-semibold text-[#333F48] sm:text-2xl`,
                children: y,
              }),
            ],
          }),
      ...
      (0, U.jsxs)(`div`, {
        className: `grid w-full place-items-center gap-2 p-1 sm:gap-3 sm:p-2 ${D}`,
        style: { contain: `layout` },
        children: [
          c
            ? null
            : (0, U.jsxs)(`div`, {
                className: `col-span-full flex min-h-[12rem] w-full max-w-2xl flex-col items-center justify-center gap-2 rounded-2xl border border-[#f7f7f7] bg-[#e8e8e8] p-6 text-[#333F48]`,
                children: [
                  (0, U.jsx)(`div`, {
                    className: `h-8 w-8 animate-spin rounded-full border-2 border-[#DA1F2C]/35 border-t-[#DA1F2C]`,
                  }),
                  (0, U.jsx)(`p`, {
      ...
      (0, U.jsx)(Nc, {
        children:
          ...
          (0, U.jsxs)(Su.div, {
            ...
            children: [
              (0, U.jsx)(Su.div, {
                className: `h-32 w-32 rounded-full border-2 border-[#DA1F2C]/45 bg-[#DA1F2C]/15 blur-2xl`,
                initial: { scale: 0, opacity: 0.8 },
                animate: { scale: 3.5, opacity: 0 },
                transition: { duration: 0.8, ease: `easeOut` },
              }),
              (0, U.jsx)(Su.p, {
                className: `pointer-events-none absolute text-2xl font-bold text-[#333F48] drop-shadow-[0_0_20px_rgba(218,31,44,0.75)] sm:text-4xl`,
...
function Hu({ onStartPlaying: e }) {
  return (0, U.jsxs)(`div`, {
    className: `flex min-h-0 w-full max-w-2xl flex-1 flex-col items-center justify-start gap-6 px-6 pt-2 text-center`,
    children: [
      (0, U.jsxs)(Su.div, {
        className: `w-full rounded-3xl border border-[#f7f7f7] bg-[#e8e8e8] p-6 shadow-2xl backdrop-blur-md sm:p-8`,
        initial: { opacity: 0, y: 16 },
        animate: { opacity: 1, y: 0 },
        transition: { type: `spring`, stiffness: 220, damping: 24 },
        children: [
          (0, U.jsx)(`h2`, {
            className: `text-3xl font-bold text-[#333F48] sm:text-4xl`,
            children: `Instructions`,
          }),
          (0, U.jsxs)(`div`, {
            className: `mt-5 space-y-2 text-lg text-[#333F48] sm:text-xl`,
            children: [
              (0, U.jsx)(`p`, { children: `Solve the 4 x 4 puzzle` }),
              (0, U.jsx)(`p`, { children: `You have 30 seconds` }),
            ],
          }),
        ],
      }),
      (0, U.jsx)(Su.button, {
        ...
        onClick: e,
        whileTap: { scale: 0.97 },
        className: `min-h-[3.8rem] w-full max-w-sm rounded-2xl border border-[#DA1F2C]/70 bg-gradient-to-b from-[#DA1F2C] to-[#AB2328] px-8 py-4 text-lg font-semibold text-white  shadow-[0_10px_28px_rgba(0,0,0,0.45),0_0_30px_rgba(218,31,44,0.3)]`,
        children: `Start Playing`,
      }),
    ],
  });
}
function Uu({ entries: e, onNextPlayer: t }) {
  return (0, U.jsxs)(`div`, {
    className: `flex min-h-0 w-full max-w-2xl flex-1 flex-col items-center justify-start gap-6 px-5 pt-2 text-center sm:px-6`,
    children: [
      (0, U.jsxs)(Su.div, {
        className: `w-full rounded-3xl border border-[#f7f7f7] bg-[#e8e8e8] p-6 shadow-2xl backdrop-blur-md sm:p-8`,
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          ...
          (0, U.jsx)(`p`, {
            className: `mt-2 text-sm text-[#333F48]`,
            children: `Top players by fastest completion time`,
          }),
          (0, U.jsxs)(`div`, {
            className: `mt-6 overflow-hidden rounded-2xl border border-[#f7f7f7] bg-[#e8e8e8]`,
            children: [
              (0, U.jsxs)(`div`, {
                className: `grid grid-cols-[4rem_1fr_7rem] bg-[#e8e8e8] px-4 py-3 text-xs font-semibold uppercase tracking-wide text-[#333F48]`,
                children: [
                  (0, U.jsx)(`span`, { children: `Rank` }),
                  (0, U.jsx)(`span`, {
                    className: `text-left`,
              ...
              (e.length ? e : [{ name: `No winners yet`, time: 0 }]).map(
                (e, t) =>
                  (0, U.jsxs)(
                    `div`,
                    {
                      className: `grid grid-cols-[4rem_1fr_7rem] border-t border-[#f7f7f7] bg-[#e8e8e8] px-4 py-3 text-sm text-[#333F48]`,
                      children: [
                        (0, U.jsxs)(`span`, {
                          className: `font-semibold text-[#DA1F2C]`,
                          children: [`#`, t + 1],
                        }),
                        (0, U.jsx)(`span`, {
                          className: `text-left`,
...
async function Z(e) {
  ...
  try {
    ...
    players[userId] = e.name || "Player";
    localStorage.setItem("voxmemory_players", JSON.stringify(players));
    localStorage.setItem("voxmemory_last_player", e.name || "Player");
...
async function Gu(e) {
  try {
    const players = JSON.parse(localStorage.getItem("voxmemory_players") || "{}");
    const lastPlayer = localStorage.getItem("voxmemory_last_player") || "Player";
    const playerName = e.name || players[e.user_id] || lastPlayer || "Player";
    
    let leaderboard = JSON.parse(localStorage.getItem("voxmemory_leaderboard_v4") || "[]");
    ...
    localStorage.setItem("voxmemory_leaderboard_v4", JSON.stringify(leaderboard));
    
    let totalTries = parseInt(localStorage.getItem("voxmemory_total_tries_v4") || "0", 10);
    localStorage.setItem("voxmemory_total_tries_v4", totalTries + 1);
...
async function Ku(e = 5) {
  try {
    let leaderboard = JSON.parse(localStorage.getItem("voxmemory_leaderboard_v4") || "[]");
    if (!Array.isArray(leaderboard)) {
      return [];
    }
    return leaderboard.slice(0, e);
  } catch (err) {
    return [];
  }
}
  ...
  return (
    ...
    (0, b.useEffect)(() => {
      e &&
        (l.current ||
          ((l.current = !0),
          Gu({ user_id: e, score: n, time: r, name: t })
            .then((e) => {
              !e.success &&
                u.current &&
                u.current(e.error || `Score save failed`);
            })
            .catch((e) => {
              u.current && u.current(String(e?.message || e));
            })));
    }, [a, e, n, r]),
    (0, U.jsxs)(`div`, {
      className: `flex min-h-0 w-full max-w-xl flex-1 flex-col items-center justify-start gap-6 px-5 pt-2 text-center sm:gap-8 sm:px-6`,
      children: [
        (0, U.jsxs)(Su.div, {
          className: `w-full rounded-3xl border border-[#f7f7f7] bg-[#e8e8e8] p-6 shadow-2xl backdrop-blur-md sm:p-8`,
          ...
          children: [
            (0, U.jsx)(`div`, {
              className: `mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full border border-[#f7f7f7] bg-[#e8e8e8] text-2xl`,
              children: a ? `✓` : `!`,
            }),
            (0, U.jsx)(`p`, {
              className: `text-sm font-medium uppercase tracking-widest text-[#DA1F2C]`,
              children: a ? `Round complete` : `Time up`,
            }),
            (0, U.jsx)(`h2`, {
              className: `mt-1 text-3xl font-bold text-[#333F48] sm:text-4xl`,
              style: { fontFamily: `var(--font-body, system-ui, sans-serif)` },
              children: a ? `Congratulations!` : `Next Player`,
            }),
            (0, U.jsx)(`p`, {
              className: `mt-2 text-[#333F48]`,
              children: a
                ? `Great job, you solved the puzzle in time.`
                : `Better luck next time`,
            }),
            (0, U.jsx)(`p`, {
              className: `mt-3 text-sm text-[#333F48]`,
              children: `You can choose the best card that suits you on the iPad`,
            }),
            (0, U.jsxs)(`div`, {
              className: `mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3`,
              children: [
                (0, U.jsxs)(`div`, {
                  className: `rounded-2xl border border-[#f7f7f7] bg-[#e8e8e8] px-4 py-3`,
                  children: [
                    (0, U.jsx)(`p`, {
                      className: `text-xs font-medium uppercase tracking-wider text-[#333F48]`,
                      children: `Score`,
                    }),
                    (0, U.jsx)(`p`, {
                      className: `text-2xl font-bold text-[#DA1F2C] sm:text-3xl`,
                      children: n,
                    }),
                  ],
                }),
                (0, U.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, U.jsx)(`p`, {
                      className: `text-2xl font-bold text-[#DA1F2C] tabular-nums sm:text-3xl`,
                      children: ((e) =>
                        `${String(Math.floor(e / 60))}:${String(e % 60).padStart(2, `0`)}`)(
                        r,
                      ),
                ...
                (0, U.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, U.jsx)(`p`, {
                      className: `text-2xl font-bold text-[#333F48] sm:text-3xl`,
                      children: i,
                    }),
                  ],
                }),
            ...
            (0, U.jsxs)(`p`, {
              className: `mt-4 text-sm text-[#333F48]`,
              children: [
                `Player: `,
                (0, U.jsx)(`span`, {
        ...
        (0, U.jsx)(Su.button, {
          type: `button`,
          onClick: o,
          whileTap: s ? void 0 : { scale: 0.97 },
          disabled: s,
          className: `min-h-[3.8rem] w-full max-w-sm rounded-2xl border border-[#DA1F2C]/70 bg-gradient-to-b from-[#DA1F2C] to-[#AB2328] px-8 py-4 text-lg font-semibold text-white shadow-[0_10px_28px_rgba(0,0,0,0.45),0_0_30px_rgba(218,31,44,0.3)] disabled:opacity-70`,
          style: { fontFamily: `var(--font-body, system-ui, sans-serif)` },
          children: s ? `Loading Leaderboard...` : `View Leaderboard`,
        }),
      ],
    })
  );
    ...
    children: [
      (0, U.jsxs)(Su.div, {
        ...
        children: [
          ...
          (0, U.jsxs)(`h1`, {
            className: `mx-auto flex flex-col items-center justify-center bg-gradient-to-r from-white via-[#F2F2F2] to-[#DA1F2C] bg-clip-text text-center text-4xl font-bold leading-[0.95] text-transparent sm:text-6xl md:text-7xl`,
            style: { fontFamily: `var(--font-body, system-ui, sans-serif)` },
            children: [
              (0, U.jsx)(`span`, {
                className: `block`,
              ...
              (0, U.jsx)(`span`, { className: `block`, children: `Match` }),
            ],
          }),
          (0, U.jsx)(`p`, {
          ...
          (0, U.jsx)(`div`, {
            className: `pointer-events-none absolute -inset-6 -z-10 rounded-3xl bg-[#DA1F2C]/12 blur-2xl`,
          }),
        ],
      }),
      (0, U.jsx)(Su.button, {
...
var Yu = 6e4,
  Xu = 2e4,
  Zu = [`screensaver.jpg`, `screensaver_ar.jpg`];
function Qu() {
  let [e, t] = (0, b.useState)(`start`),
    [n, r] = (0, b.useState)(``),
    [i, a] = (0, b.useState)(``),
    [o, s] = (0, b.useState)(!1),
    [c, l] = (0, b.useState)(``),
    ...
    [x, S] = (0, b.useState)(!1),
    [C, w] = (0, b.useState)(!1),
    [ee, te] = (0, b.useState)(0),
    ne = (0, b.useRef)(0),
    ssOpenTime = (0, b.useRef)(0),
    T = (0, b.useRef)(e);
  ((0, b.useEffect)(() => {
    ne.current = Date.now();
  }, []),
  ...
  let re = (0, b.useCallback)(() => {
    if (Date.now() - ssOpenTime.current < 1500) return;
    ((ne.current = Date.now()), w(!1));
  }, []);
  ((0, b.useEffect)(() => {
    let e = (event) => {
        ne.current = Date.now();
        if (Date.now() - ssOpenTime.current < 1500) return;
        if (event && (event.type === 'pointerdown' || event.type === 'touchstart')) return;
        w(!1);
      },
      n = [
        `pointerdown`,
    ...
    for (let t of n) document.addEventListener(t, e, { passive: !0 });
    let i = setInterval(() => {
      Date.now() - ne.current < Yu ||
        (w(!1),
        t(`start`),
        r(``),
        a(``),
    ...
    return () => {
      clearInterval(i);
      for (let t of n) document.removeEventListener(t, e);
    };
  }, []),
    (0, b.useEffect)(() => {
      let e = () => {
        let e = Date.now() - ne.current >= Yu,
          t = T.current !== `game`;
        e && t && w(!0);
      };
      e();
  ...
  let ie = (0, b.useCallback)(() => {
    ...
    ae = async (e) => {
      ...
      try {
        let n = e.name.trim();
        r(n);
        let i = await Z({ name: n });
        if (!i.success || !i.user_id) {
          l(i.error || `Could not register. Try again.`);
          return;
        }
        (a(i.user_id), t(`instructions`));
      } catch (e) {
        l(String(e?.message || e));
      } finally {
        s(!1);
      }
    },
  ...
  return (0, U.jsxs)(`div`, {
    className: `relative flex min-h-[100dvh] w-full flex-col items-stretch overflow-hidden bg-[#000000] text-[#333F48]`,
    onPointerDown: re,
    children: [
      (0, U.jsx)(`img`, {
        src: `./images/bg.png`,
      ...
      (0, U.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-0 bg-black/8`,
      }),
      (0, U.jsx)(`div`, {
      ...
      x
        ? null
        : (0, U.jsx)(`header`, {
            className: `pointer-events-none absolute bottom-0 left-0 right-0 z-30 flex items-center justify-end gap-2 p-3 sm:p-4`,
            children: (0, U.jsx)(`button`, {
              type: `button`,
              onClick: (e) => {
                (e.stopPropagation(), re(), ie());
              },
              className: `pointer-events-auto rounded-xl border border-[#33424A]/70 bg-white/75 px-3 py-2 text-xs font-medium text-white shadow-lg backdrop-blur-md sm:text-sm`,
              children: `Fullscreen`,
            }),
          }),
      v
        ? (0, U.jsx)(`div`, {
            className: `absolute bottom-4 left-1/2 z-30 -translate-x-1/2 rounded-xl border border-[#33424A]/50 bg-white/90 px-4 py-2 text-sm text-[#333F48] shadow-[0_0_24px_rgba(51,63,72,0.18)]`,
            children: v,
          })
        : null,
      C
        ? (0, U.jsx)(`div`, {
            ...
            "aria-hidden": !0,
            onClick: (e) => {
              (e.stopPropagation(), e.preventDefault(), re());
            },
            children: (0, U.jsx)(
              `img`,
              {
        ...
        : null,
      (0, U.jsx)(`main`, {
        className: `relative z-10 flex min-h-0 flex-1 flex-col items-center justify-start pt-20 sm:pt-24 md:pt-28`,
        children: (0, U.jsx)(Nc, {
          mode: `wait`,
          children: (0, U.jsxs)(
            Su.div,
            {
              className: `flex min-h-0 w-full flex-1 flex-col items-center justify-start pt-3 sm:pt-4`,
              ...
              children: [
                ...
                e === `form` &&
                  (0, U.jsx)(Ou, { onSubmit: ae, loading: o, error: c }),
                e === `instructions` &&
                  (0, U.jsx)(Hu, {
                    onStartPlaying: () => {
                      (re(), d((e) => e + 1), t(`game`));
...
(0, x.createRoot)(document.getElementById(`root`)).render(
  (0, U.jsx)(b.StrictMode, { children: (0, U.jsx)(Qu, {}) }),
);
